				...
				switch(_getFileType(pp_images[set_position])){
					case 'image':
						...
						imgPreloader.onload = function(){
							...
							if(imgPreloader.width > 980)
		
							correctSizes = _fitToViewport(980,((imgPreloader.height/72)-((imgPreloader.width/72) - (980/72)))*72);
                         
							//correctSizes = _fitToViewport(imgPreloader.width,imgPreloader.height);
                            else if(imgPreloader.height > 704)
                            {
                            	correctSizes = _fitToViewport(((imgPreloader.width/72)-((imgPreloader.height/72) - (704/72)))*72,704);
                            }
                            else 
                            correctSizes = _fitToViewport(imgPreloader.width,imgPreloader.height);
